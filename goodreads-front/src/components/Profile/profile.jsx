...
class Profile extends Component {
  ...
  fetchUserDetails = () =>{
    ...
    .then((response) => {
      ...
      this.setState({firstname:JSON.stringify(response.data.firstname).replace(/['"]+/g, '')});
      this.setState({lastname:JSON.stringify(response.data.lastname).replace(/['"]+/g, '')});
      this.setState({username:JSON.stringify(response.data.username).replace(/['"]+/g, '')});
      if( JSON.stringify(response.data.image) )
      {
          this.setState({profileImage:JSON.stringify(response.data.image).replace(/['"]+/g, '')});
          // console.log(this.state.profileImage);
      }
      this.setState({email:JSON.stringify(response.data.email).replace(/['"]+/g, '')})
      this.setState({bio:JSON.stringify(response.data.bio).replace(/['"]+/g, '')});
    })
  ...
  componentDidMount(){
    ...
    render() {
      ...
      const card = document.querySelector(".procard");
      ...
      if(this.state.profileImage){
        ...
        return (
          ...
          <div class="procard" data-state="#about">
  <div class="card-header">
    <div class="card-cover" style={{backgroundImage:'url(' + profilePic + ')'}}></div>
    <img class="card-avatar" src={profilePic} alt="avatar" />
    <h1 class="card-fullname">{this.state.firstname + " " + this.state.lastname}</h1>
    
    {/* <h2 class="card-jobtitle">UI Developer</h2> */}
  </div>
  <div class="card-main">
  <div class="card-buttons">
      <button data-section="#about" class="is-active">درباره</button>
      <button data-section="#experience">علاقه مندی ها</button>
      <button data-section="#contact">اطلاعات</button>
    </div>
    <div class="card-section is-active" id="about">
      <div class="card-content">
        <div class="card-subtitle">درباره</div>
        <p class="card-desc">{this.state.bio}
        </p>
      </div>
    ...
    <div class="card-section" id="experience">
      <div class="card-content">
        <div class="card-subtitle">علاقه های من</div>
    ...
    <div class="card-section" id="contact">
      <div class="card-content">
        <div class="card-subtitle">اطلاعات</div>
    ...
    {/* <div class="card-buttons">
      <button data-section="#about" class="is-active">درباره</button>
      <button data-section="#experience">علاقه مندی ها</button>
      <button data-section="#contact">مخاطب</button>
    </div> */}
  </div>
</div>
...
//   <h2 class="card-jobtitle">{this.state.username}</h2>
// </div>
// <div class="card-main">
//   <div class="card-section is-active" id="about">
//     <div class="card-content">
...
//   <div class="card-section" id="experience">
//     <div class="card-content">
//       <div class="card-subtitle">علاقه مندی ها</div>
//       {/* <div class="card-timeline">
//         <div class="card-item" data-year="2014">
//           <div class="card-item-title">Front-end Developer at <span>JotForm</span></div>
//           <div class="card-item-desc">Disrupt stumptown retro everyday carry unicorn.</div>
...
//   <div class="card-section" id="contact">
//     <div class="card-content">
//       <div class="card-subtitle">مخاطب</div>
//       <div class="card-contact-wrapper">
//         {/* <div class="card-contact">
//           <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
//             <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z" />
//             <circle cx="12" cy="10" r="3" /></svg>
//           Algonquin Rd, Three Oaks Vintage, MI, 49128
//         </div> */}
...
//     <button data-section="#experience" >
//       علاقه مندی ها
//         </button>
